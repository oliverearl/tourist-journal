...
Conference.dataContext = (function ($) {
  ...
  const populateDB = function(tx) {
    ...
    tx.executeSql("INSERT INTO \"entries\" (\"id\",\"name\", \"notes\", \"photo\", \"date_of_entry\", \"location\") VALUES (null, 'This one has no photo', 'This is a sample description.', null, '2019-01-01 14:56:54.919', '(52.415303,-4.082920)')", [], insertSuccess, errorDB);
  };
